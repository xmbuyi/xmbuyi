	...
	*/
	public class RotatingRectangle
	{
		...
		public static function drawMask():void {
			...
			_mask.graphics.drawRect(-_stage.stageWidth/2, -_stage.stageHeight/2, _stage.stageWidth, _stage.stageHeight);
		...
		public static function animateOut(onComplete:Function):void {
			TweenLite.to(_mask, 0.55, { scaleX:0, scaleY:0, rotation:-270, onComplete:onComplete} );
		}
