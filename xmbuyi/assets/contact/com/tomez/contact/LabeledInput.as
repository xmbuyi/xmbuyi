package com.tomez.contact 
{
	...
	* @author Tomez
	*/
	public class LabeledInput extends TSprite
	{
		...
		public function LabeledInput(label:String, targetWidth:Number = 320, targetHeight:Number = 30) 
		{
		...
		private function drawText():void {
			...
			inf.d_text.multiline = false;
			inf.d_text.width = targetWidth - 6;
			inf.d_text.htmlText = "";
			inf.d_text.height = inf.d_text.textHeight + 4;
